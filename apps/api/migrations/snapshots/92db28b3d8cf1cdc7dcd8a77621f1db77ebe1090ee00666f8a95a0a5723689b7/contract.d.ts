...
export type StorageHash =
  StorageHashBase<'92db28b3d8cf1cdc7dcd8a77621f1db77ebe1090ee00666f8a95a0a5723689b7'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly WorkOrder: {
      ...
      readonly description: Varchar<2000> | null;
...
export type StorageColumnTypes = {
  readonly public: {
    ...
    readonly work_orders: {
      ...
      readonly description: Varchar<2000> | null;
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly scheduled_end_at: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly scheduled_start_at: CodecTypes['pg/timestamptz-string@1']['output'] | null;
...
export type StorageColumnInputTypes = {
  readonly public: {
    ...
    readonly work_orders: {
      ...
      readonly description: CodecTypes['sql/varchar@1']['input'] | null;
      readonly id: CodecTypes['pg/uuid@1']['input'];
      readonly scheduled_end_at: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly scheduled_start_at: CodecTypes['pg/timestamptz-string@1']['input'] | null;
            ...
            readonly work_orders: {
              columns: {
                ...
                readonly description: {
                  ...
                  readonly codecId: 'sql/varchar@1';
                  readonly nullable: true;
                  readonly typeParams: { readonly length: 2000 };
                };
                readonly scheduled_start_at: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
                  readonly nullable: true;
                };
                readonly scheduled_end_at: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
                  readonly nullable: true;
                };
          ...
          readonly WorkOrder: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly scheduledStartAt: { readonly column: 'scheduled_start_at' };
                readonly scheduledEndAt: { readonly column: 'scheduled_end_at' };
